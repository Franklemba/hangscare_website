    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-slate-600">Born From the Hospital Ward</p>
        </div>

        <div className="space-y-12">
          {/* Opening Quote */}
          <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-8 sm:p-12 border-l-4 border-blue-600">
          ...
          {/* The Heartbreak */}
          <div className="bg-blue-50 p-8 sm:p-12 rounded-xl border border-blue-200">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-700 leading-relaxed">
              We began with a simple but powerful question: <span className="font-semibold text-blue-600">What if someone showed up?</span>
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
          ...
          {/* Call to Action */}
          <div className="bg-blue-600 text-white p-8 sm:p-12 rounded-xl text-center">
